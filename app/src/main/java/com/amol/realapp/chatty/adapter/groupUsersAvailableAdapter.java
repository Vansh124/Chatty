...
public class groupUsersAvailableAdapter extends RecyclerView.Adapter<groupUsersAvailableAdapter.groupUserAvailItemHolder> implements Filterable {
    ...
    private String key;
    public groupUsersAvailableAdapter(Context context, ArrayList<groupUsersAvailable> groupAvailList,String key) {
    ...
    @Override
    public groupUsersAvailableAdapter.groupUserAvailItemHolder onCreateViewHolder(ViewGroup p1, int p2) {
       View v=LayoutInflater.from(context).inflate(R.layout.users_available_group_item_layout,p1,false);
       
       return new groupUserAvailItemHolder(v);
    }

    @Override
    public void onBindViewHolder(final groupUsersAvailableAdapter.groupUserAvailItemHolder p1, final int p2) {
        ...
        p1.detailsContainer.setOnClickListener(new View.OnClickListener() {
                ...
                groupUsersAvailable grpUsers=groupAvailList.get(p2);
                 ...
                 FirebaseDatabase.getInstance().getReference()
                        .child("Groups").child(key).child("Members").child(grpUsers.getUid()).setValue(grpUsers);
