...
public class StoriesView extends LinearLayout {
    ...
    public interface StoriesListener {
       ...
       // public void onStrResume();
       // public void onStrPause();
    }
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StoriesView);
        storiesCount = typedArray.getInt(R.styleable.StoriesView_progressCount, 0);
        typedArray.recycle();
        bindViews();
    }
