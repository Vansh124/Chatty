...
public class GroupsFragment extends Fragment {
  ...
  private void init() {
    SharedPreferences sPref =
        getActivity().getSharedPreferences("pushKeyFile", Context.MODE_PRIVATE);
          ...
          public void onDataChange(DataSnapshot p1) {
            if (p1.exists()) {
              ...
              for (DataSnapshot mSnap : p1.getChildren()) {
                ...
                String groupName =
                    mSnap.child("groupInfo").child("groupName").getValue(String.class);
                String groupProfile =
                    mSnap.child("groupInfo").child("groupProfile").getValue(String.class);
                String uid =
                    mSnap
                        .child("Members")
                        .child(FirebaseAuth.getInstance().getUid())
