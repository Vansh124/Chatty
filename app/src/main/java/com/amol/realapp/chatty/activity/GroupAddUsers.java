...
public class GroupAddUsers extends AppCompatActivity {
   ...
   setSupportActionBar(toolbar);
    ...
    private void initListener() {
           key=FirebaseDatabase.getInstance().getReference().push().getKey()+FirebaseAuth.getInstance().getUid();
    ...
    .addValueEventListener(new ValueEventListener(){
                ...
                public void onDataChange(DataSnapshot p1) {
                        ...
                        for(DataSnapshot gSnapShot:p1.getChildren()){
                           ...
                           final groupUsersAvailable gAvailUsers=gSnapShot.getValue(groupUsersAvailable.class);
    ...
    groupUsersAvailAdapter=new groupUsersAvailableAdapter(GroupAddUsers.this,groupAvailList,key);
    ...
    refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener(){
        ...
        proceedGroupUsersDetails.setOnClickListener(new View.OnClickListener() {
                                   ...
                                   currentUserUid=p1.child("uid").getValue(String.class);  
                                     ...
                                     FirebaseDatabase.getInstance().getReference()
                                        ...
                                        .child(key)
                                         .child("Members")
                                         .child(FirebaseAuth.getInstance().getUid())
                                         .setValue(currentUserGroup).addOnCompleteListener(new OnCompleteListener<Void>(){
                                             ...
                                             public void onComplete(Task<Void> p1) {
                                                 if(p1.isSuccessful()){
                                                     ...
                                                     edt.commit();
                                                     Intent intent=new Intent(GroupAddUsers.this,GroupActivity.class);
                                                      startActivity(intent);
                                                      
                                                     Toast.makeText(GroupAddUsers.this, "Successfully Created Group", Toast.LENGTH_SHORT).show();
                                                 }
