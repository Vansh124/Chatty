...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        final StorageReference sRef=  FirebaseStorage.getInstance().getReference().child("status").child(date.getTime()+"");
             sRef.putFile(data.getData()).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>(){
