...
public class groupListAdapter extends RecyclerView.Adapter<groupListAdapter.groupItemHolder> {
    ...
    public groupListAdapter.groupItemHolder onCreateViewHolder(ViewGroup p1, int p2) {
        View v=LayoutInflater.from(context).inflate(R.layout.group_frg_details_list_item_layout,p1,false);
    ...
    Picasso.get().load(gProfile.getGroupProfile()).fit().centerCrop()
    .placeholder(R.drawable.ic_profile)
    .networkPolicy(NetworkPolicy.OFFLINE)
            .into(p1.groupImage, new Callback(){
    ...
    FirebaseDatabase.getInstance().getReference().child("Group-Chats")
            ...
            .addValueEventListener(new ValueEventListener(){
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
                        ...
                        String lastMssg=dataSnapshot.child("lstMsg").child("lastMessage").getValue(String.class);
                        long time=dataSnapshot.child("lstMsg").child("lastMessageTime").getValue(long.class);
    ...
    p1.groupImage.setOnTouchListener(new View.OnTouchListener(){
                ...
                public boolean onTouch(View view, MotionEvent event) {
                    ...
                    if (action == MotionEvent.ACTION_DOWN) {
                        ...
                        if(!gProfile.getGroupProfile().equals("no image")){
                            ...
                            Glide.with(context).load(gProfile.getGroupProfile()).centerCrop().diskCacheStrategy(DiskCacheStrategy.DATA).into(userDialogProfileImage);
                        ...
                        userDialogInfo.setOnClickListener(new View.OnClickListener() {
                                ...
                                @Override
                                public void onClick(View view) {
                                    Toast.makeText(context, "Group: "+gProfile.getGroupName()+"-info", Toast.LENGTH_SHORT).show();
                                }
                            });
        ...
        p1.groupContainer.setOnClickListener(new View.OnClickListener() {
